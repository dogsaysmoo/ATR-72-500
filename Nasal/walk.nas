...
var walk_about = func(wa_distance) {
	...
	if (i == view.indexof("Pilot View") or i == view.indexof("Model View") or i == view.indexof("Passenger View") or i == view.indexof("Copilot View") or i == view.indexof("Cabin View")) {
